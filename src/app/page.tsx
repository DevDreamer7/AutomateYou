  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-x-hidden">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section id="home" className="container mx-auto flex flex-col items-center justify-center text-center min-h-[calc(100vh-56px)] px-4 py-20">
        ...
        <section id="education" className="py-20 lg:py-32 bg-card/20">
          <div className="container mx-auto px-4">
